const questions = [
  ...
  { 
    ...
    options: ["Sverige", "Frankrike", "Tyskland", "Spanien"], 
    correct: "Frankrike" 
  },
  { 
    question: "Vilken kommun är minst?", 
    options: ["Lycksele", "Nordmaling", "Bjurholm", "Vännäs"], 
    correct: "Bjurholm" 
  },
  { 
    question: "Vilken kommun ligger i Västerbotten?", 
    options: ["Umeå", "Borlänge", "Boden", "Piteå"], 
    correct: "Umeå" 
  },
  { 
    question: "Vilken kontinent har flest länder?", 
    options: ["Asien", "Europa", "Afrika", "Nordamerika"], 
    correct: "Afrika" 
  },
  { 
    question: "Vilket land har den största befolkningen?", 
    options: ["Kina", "Sudan", "USA", "Indien"], 
    correct: "Kina" 
  },
  { 
    question: "Vilket år kollapsade Sovjetunionen?", 
    options: ["1991", "1985", "1945", "1925"], 
    correct: "1991" 
  },
  { 
...
function checkAnswer(selectedOption) {
  ...
  if (selectedOption === currentQuestion.correct) {
    ...
    if (firstAttempt) {
      points -= 2; // Straff (-2) vid första försöket
    }
